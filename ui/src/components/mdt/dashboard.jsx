        ...
        <>
            <div className="dashboard">
                ...
                <div className="dashboard-header">
                    <div>
                        <div className="dashboard-title">Hi Osman,</div>
                    ...
                    <div className="profile">
                        ...
                        <div className="profile-info">
                            <div className="name">Osman Saleem</div>
                            <div className="grade">Seargent</div>
                        </div>
                    </div>
                        ...
                        <div className="dashboard-bottom-inner">
                            ...
                            <div className="dashboard-location-top">
                                <div >
                                    ...
                                    <div className="dashboard-location-title">Mission Row</div>
                                </div>
                                <div className="dashboard-location-description" >Police department located nearthe legion square</div>
                            </div>
                        ...
                        <div className="dashboard-bottom-inner">
                            ...
                            <div className="dasboard-account-header">
                                ...
                                <div className="account-label">
                                    ...
                                    <div className="description">Police@...com</div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="balance">$1202302</div>
                            </div>
                            ...
                            <div className="hire-wrapper">
                                ...
                                <div className="hire-container">
                                    <div className="hire-employee">
                                        <div  className="hire-id">1</div>
                                        <div className="hire-name">Osman Saleem</div>
